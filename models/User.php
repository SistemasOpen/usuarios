...
class User extends ActiveRecord implements IdentityInterface
{
     ...
     * @return static|null
     */
    public static function findByUsername($username, $empresa)
    {
        return static::findOne(['legajo' => $username, 'empresa'=>$empresa, 'activo' => self::STATUS_ACTIVE]);
    }
     ...
     */
    public function validatePassword($password,$empresa,$username)
    {

        $sql = "pa_buscarusuarioypass " . $empresa . ", " . $username . ", '" . $password."'";
