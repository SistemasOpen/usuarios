...
class AreasController extends Controller
{
    ...
    public function actionSectores($id){
        ...
        echo json_encode(ArrayHelper::map(Sectores::find()->all()));
        //echo json_decode($DPartList->models);
    }

    public function actionDepartamentos($id){
        
        echo json_encode(ArrayHelper::map(Departamentos::find()->all()));
        //echo json_decode($DPartList->models);
    }

    public function actionGerencias($id){
        
        echo json_encode(ArrayHelper::map(Gerencias::find()->all()));
        //echo json_decode($DPartList->models);
    }

    public function actionUsuariojefes($id){
        
        echo json_encode(ArrayHelper::map(Usuario::find()->all(), 'id', 'nombre'));
        //echo json_decode($DPartList->models);
    }
